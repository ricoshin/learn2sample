...
def split_meta(meta, mode):
  if mode == 'class':
    # [episode] i
    s, q = meta.split_class(0.3)  # meta-s : meta_q = 30 : 70
    #   [meta_train]  j
    s_load = s.get_loader(batch_size=128)
    import pdb; pdb.set_trace()
    # s = s.sample_class(0.5)  # 35 x 10 = 350


  elif mode == 'instance':
    s, q = meta.split_instance(0.7)
  ss, sq = s.split_instance(0.7)
  qs, qq = q.split_instance(0.7)
...
m_train, m_test = meta.split_class(0.1)
